...
const pushLogs = require('rtcmulticonnection-server/node_scripts/pushLogs.js');
const BASH_COLORS_HELPER = require('rtcmulticonnection-server/node_scripts/BASH_COLORS_HELPER.js');
