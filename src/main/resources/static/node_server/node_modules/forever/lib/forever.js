...
var fs = require('fs'),
    ...
    async = require('async'),
    configUtils = require('forever/lib/util/config-utils');
...
forever.Worker       = require('forever/lib/forever/worker').Worker;
forever.cli          = require('forever/lib/forever/cli');

//
// Expose version through `pkginfo`
//
exports.version = require('forever/package.json').version;
