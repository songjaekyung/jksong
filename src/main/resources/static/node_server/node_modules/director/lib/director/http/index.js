var events = require('events'),
    ...
    util = require('util'),
    BaseRouter = require('director/lib/director/router').Router,
    responses = require('director/lib/director/http/responses');

//
// ### Expose all HTTP methods and responses
//
exports.methods   = require('director/lib/director/http/methods');
