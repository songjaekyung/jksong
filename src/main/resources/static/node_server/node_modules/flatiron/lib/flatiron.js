...
//
flatiron.common    = require('flatiron/lib/flatiron/common');
flatiron.constants = require('flatiron/lib/flatiron/constants');
flatiron.formats   = broadway.formats;
flatiron.App       = require('flatiron/lib/flatiron/app').App;
flatiron.version   = require('flatiron/package.json').version;
